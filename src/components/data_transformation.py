...
class DataTransformation:
    ...
    def get_data_transformer_obj(self):
        try:
            ...
            logging.info(f"Categorical columns: {categorical_columns} stardadized")
            logging.info(f"Numerical columns: {numerical_columns} one hot encoded")
            
            preprocessor = ColumnTransformer(
                [
                    ('num_pipe', num_pipeline, numerical_columns),
                    ('cat_pipe', num_pipeline, numerical_columns)
                ]
            )
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info('Applying processing object do the train and test dataframe')
